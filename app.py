...
# ---------------------------------------------------------
# ฟีเจอร์ 3: สแกนลิงก์ (AI) -> ✨ แก้ไขใหม่ (ปลดล็อก Safety) ✨
# ---------------------------------------------------------
    ...
    if st.button("สแกนลิงก์"):
        if url_input:
            with st.spinner("🔍 กำลังส่องกล้องขยาย..."):
                try:
                    # ตั้งค่าความปลอดภัย: ยอมให้ AI อ่านเนื้อหาล่อแหลม/อันตรายได้ (เพื่อการตรวจสอบ)
                    safety_settings = [
                        {
                    ...
                    # ส่งคำสั่งพร้อมแนบใบอนุญาต safety_settings
                    ...
                    # โชว์ Error ของจริงออกมาเลย จะได้รู้ว่าพังเพราะอะไร
